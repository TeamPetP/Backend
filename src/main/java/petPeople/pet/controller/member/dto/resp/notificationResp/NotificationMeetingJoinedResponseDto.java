...
@Getter
@Setter
@ApiModel(description = "회원의 모임 가입 알림 응답 DTO")
public class NotificationMeetingJoinedResponseDto extends MemberNotificationResponseDto {
    ...
    public NotificationMeetingJoinedResponseDto(Notification notification) {
        super(notification, "meetingJoinedRequest");
